...
/// at a time, but there is no restriction on which threads may use it.
static MANAGER: Mutex<Option<Manager<Backend>>> = Mutex::new(None);

// See osclientcerts for documentation on these same macros.
...
const LIBRARY_DESCRIPTION_BYTES: &[u8; 32] = b"Remote Certificates Module      ";
...
#[allow(non_snake_case)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn RemoteCerts_C_GetFunctionList(
